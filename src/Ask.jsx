  ...
  return (
    <div className='Ask' style={{display:'flex', justifyContent:'center',flexDirection:'column', alignItems:'center'}}>
        ...
        <div ref={yesButtonRef} className="flex justify-center gap-4 mt-6">
          <div onClick={(e)=>{onYes(e)}} style={{cursor:"pointer"}} className="select-none px-6 py-2 bg-pink-500 text-white font-semibold rounded-lg hover:bg-pink-600 transition text-center items-center justify-center flex">
            Yes 💖
          </div>
          <div ref={noButtonRef} onClick={handleClick} onMouseEnter={handleHover} style={{cursor:"pointer"}} className="select-none px-6 py-2 bg-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-400 transition">
            No 💔
          </div>
          <div><img ref={brickImageRef} style={{display:"none", width:"10em", height:"10em", cursor:"pointer"}} src="https://upload.wikimedia.org/wikipedia/commons/thumb/1/14/Background_brick_wall.jpg/960px-Background_brick_wall.jpg" alt="Heart GIF" className="w-16 h-16 ml-4" />
          </div>
